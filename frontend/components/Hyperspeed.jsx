...
/**
 * Options are merged over DEFAULT_EFFECT_OPTIONS, so a caller may pass any
 * subset. Typed loosely on purpose: inferring the prop type from the default
 * object would make every key required — including the onSpeedUp/onSlowDown
 * callbacks, which a server component cannot pass across the RSC boundary.
 *
 * @param {{ effectOptions?: Partial<typeof DEFAULT_EFFECT_OPTIONS> }} props
 */
