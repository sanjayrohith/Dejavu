Dejavu Proprietary License

Copyright (c) 2026 Sanjay Rohith. All Rights Reserved.

1. Ownership

This software and all associated source code, documentation, assets, and
files in this repository (the "Software") are the exclusive property of
...
no person or entity may:
  ...
  c. modify the Software and distribute or sell the modified version,
     including versions with added, removed, or changed features;
  d. use the Software, or any portion of its source code, as a base,
     template, dependency, or component of another project, product, or
     service;
  e. incorporate any part of the Software's source code into any other
     codebase, public or private, commercial or noncommercial;
  f. publicly host, mirror, or re-publish the Software or a derivative of
     it under a different name or repository.

Viewing the source code in this public repository does not grant any of
...
Requests submitted to the official repository.
  ...
  b. You grant the Owner a perpetual, worldwide, irrevocable,
     ...
     part, without further obligation, credit, or compensation to you.
  c. You agree that the Owner retains full and sole ownership of the
     Software, including any Contribution once it is merged or
     incorporated. Submitting a Contribution does not grant you any
     ownership stake, co-authorship rights, or license to use the
     Software beyond what this license otherwise allows.
  d. You confirm that your Contribution is your own original work and
...
---
This is not an open-source license. It is a proprietary, source-available
license. This document is provided for convenience and does not
