...
- authority write: 7.00ms; local apply: 0.01ms; local recall: 0.43ms
- hits=1, revision=1
- PASS: true

## T2 — peer streamed visibility latency

- authority write+own ack: 3.59ms
- receipt start -> bob local visible: 3.68ms
- bob local hits=1
- PASS: true

## T3 — warm local recall latency

- bob warm local recall p50=0.01ms p95=0.01ms max=0.02ms
- PASS: true
...
- catchUp applied=0 2.05ms; after behind=0; local gap hits=5
- PASS: true
